			...
			<form id="form-{{$dir_submodulo}}" onsubmit="md_guardar(event,'btn-save')">
				...
				<div class="modal-body modal_body">
					...
					<div class="form-group form-row">
						...
						<div class="col-md-6">
							<label for="{{$prefix}}_sitios" class="col-form-label">Sitios</label>
							<input class="form-control form-control-sm" type="text" placeholder="Cantidad de Sitios" id="{{$prefix}}_sitios" name="sitios">
						</div>
					</div>
