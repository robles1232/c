			...
			<form id="form-{{$dir_submodulo}}" onsubmit="md_guardar(event,'btn-save')">
				...
				<div class="modal-body modal_body">
					...
					<div class="form-group form-row">
						<div class="col-md-10">
							<label for="{{$prefix}}_descripcion" class="col-form-label">Sección</label>
							<input class="form-control form-control-sm" type="text" placeholder="Sección de la Carta" id="{{$prefix}}_descripcion" name="descripcion">
						</div>
