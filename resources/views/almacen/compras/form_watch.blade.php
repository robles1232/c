					...
					<div class="form-group form-row">
						...
						<div class="div_total mt-2">
							<article class="article_total d-flex">
								<b><h5>Total Compra: 0.00</h5></b> 
							</article>
						</div>

						@foreach($data->compras_credito as $cr)
							<div class="col-md-3 offset-md-6">
								<label for="{{$prefix}}_fecha_pago" class="col-form-label">Fecha de pago</label>
								<input type="date" class="form-control form-control-sm" id="{{$prefix}}_fecha_pago" name="fecha_pago" value="{{$cr->fecha_pago}}" disabled>
							</div>

							<div class="col-md-3 ">
								<label for="{{$prefix}}_letra" class="col-form-label">Pago</label>
								<input type="number" class="form-control form-control-sm" id="{{$prefix}}_letra" name="letra" placeholder="0.00" value="{{$cr->letra}}" disabled>
							</div>
						@endforeach
						<div class="div_total mt-2">
...
<script src='{{asset("js/views/$dir_modulo/$dir_submodulo/script_watch.js")}}'></script>
